  ...
  return function (createFFmpegCore) {
    ...
    if (h) {
      ...
      ("undefined" != typeof read &&
        ...
        "undefined" != typeof scriptArgs ? (fa = scriptArgs) : "undefined" != typeof arguments && (fa = arguments),
    ...
    var M = {
      ...
      Qi: function (a) {
        var b = pb | 0;
        b && (Atomics.store(F, (b + 4) >> 2, a), Atomics.store(F, (b + 0) >> 2, 1), Atomics.store(F, (b + 60) >> 2, 1), Atomics.store(F, (b + 64) >> 2, 0), M.eh(), tb(b + 0, 2147483647), sb(0, 0, 0), (threadInfoStruct = 0), l && postMessage({ cmd: "exit" }));
      },
      Pi: function () {
        M.eh();
      ...
      O = {
        ...
        ff: function (a, b) {
          ...
          for (d = 0; d < a.length; d++) {
            ...
            if (!g || b.wf) for (g = 0; O.Mf(e.mode); ) if (((e = O.readlink(c)), (c = Ub(Qb(c), e)), (e = O.ff(c, { ah: b.ah }).node), 40 < g++)) throw new O.af(32);
          }
        ...
        ji: { r: 0, rs: 1052672, "r+": 2, w: 577, wx: 705, xw: 705, "w+": 578, "wx+": 706, "xw+": 706, a: 1089, ax: 1217, xa: 1217, "a+": 1090, "ax+": 1218, "xa+": 1218 },
        Dh: function (a) {
          var b = O.ji[a];
        ...
        zi: function (a, b) {
          return a ? (O.Mf(a.mode) ? 32 : O.kf(a.mode) && ("r" !== O.th(b) || b & 512) ? 31 : O.Jf(a, O.th(b))) : 44;
        },
        Qh: 4096,
        Bi: function (a, b) {
          b = b || O.Qh;
        ...
        Kh: function (a, b) {
          ...
          O.Cg++;
          1 < O.Cg && u("warning: " + O.Cg + " FS.syncfs operations in flight at once, probably just doing extra work");
        ...
        open: function (a, b, c, d, e) {
          ...
          b &= -131713;
          d = O.nh({ node: g, path: O.If(g), flags: b, seekable: !0, position: 0, df: g.df, Wi: [], error: !1 }, d, e);
          d.df.open && d.df.open(d);
          !f.logReadFiles || b & 1 || (O.$g || (O.$g = {}), a in O.$g || ((O.$g[a] = 1), u("FS.trackingDelegate error on read file: " + a)));
          try {
            O.mf.onOpenFile && ((e = 0), 1 !== (b & 2097155) && (e |= O.Mh.Gh.Rh), 0 !== (b & 2097155) && (e |= O.Mh.Gh.Sh), O.mf.onOpenFile(a, e));
          } catch (m) {
        ...
        ei: function () {
          ...
          f.stdin ? O.Hf("/dev", "stdin", f.stdin) : O.symlink("/dev/tty", "/dev/stdin");
      ...
      try {
        ...
        for (var g = b ? E[b >> 2] : 0, k = b ? E[(b + 4) >> 2] : 0, m = c ? E[c >> 2] : 0, r = c ? E[(c + 4) >> 2] : 0, q = d ? E[d >> 2] : 0, t = d ? E[(d + 4) >> 2] : 0, w = 0, B = 0, p = 0, x = 0, z = 0, I = 0, W = (b ? E[b >> 2] : 0) | (c ? E[c >> 2] : 0) | (d ? E[d >> 2] : 0), db = (b ? E[(b + 4) >> 2] : 0) | (c ? E[(c + 4) >> 2] : 0) | (d ? E[(d + 4) >> 2] : 0), K = 0; K < a; K++) {
          ...
          if (32 > K ? W & Y : db & Y) {
            ...
            na & 2 && (32 > K ? q & Y : t & Y) && (32 > K ? (z |= Y) : (I |= Y), e++);
          }
        }
        b && ((E[b >> 2] = w), (E[(b + 4) >> 2] = B));
        c && ((E[c >> 2] = p), (E[(c + 4) >> 2] = x));
    ...
    function lc(a, b) {
      ...
      try {
        ...
        if (b & -8) var c = -28;
          ...
          var d;
          (d = O.ff(a, { wf: !0 }).node) ? ((a = ""), b & 4 && (a += "r"), b & 2 && (a += "w"), b & 1 && (a += "x"), (c = a && O.Jf(d, a) ? -2 : 0)) : (c = -44);
        }
        return c;
      } catch (e) {
    ...
    function oc(a, b, c) {
      ...
      try {
        ...
        for (var e = O.tf(d, 0, 1), g = Math.floor(e / 280); g < d.Lf.length && a + 280 <= c; ) {
          ...
          E[(b + a) >> 2] = L[0];
          E[(b + a + 4) >> 2] = L[1];
          L = [(280 * (g + 1)) >>> 0, ((J = 280 * (g + 1)), 1 <= +Math.abs(J) ? (0 < J ? (Math.min(+Math.floor(J / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0) : 0)];
          E[(b + a + 8) >> 2] = L[0];
          E[(b + a + 12) >> 2] = L[1];
          Qa[(b + a + 16) >> 1] = 280;
          y[(b + a + 18) >> 0] = r;
    ...
    var R = {
      ...
      createSocket: function (a, b, c) {
        b &= -526337;
        c && assert((1 == b) == (6 == c));
        a = { family: a, type: b, protocol: c, lf: null, error: null, ng: {}, pending: [], ag: [], pf: R.qf };
        b = R.zg();
        c = O.createNode(R.root, b, 49152, 0);
        c.bg = a;
        b = O.nh({ path: b, node: c, flags: O.Dh("r+"), seekable: !1, df: R.df });
        a.stream = b;
        return a;
      },
      mi: function (a) {
      ...
      qf: {
        ...
        ni: function (a, b) {
          ...
          function d(g) {
            ...
            var k = e;
            e = !1;
            k && 10 === g.length && 255 === g[0] && 255 === g[1] && 255 === g[2] && 255 === g[3] && 112 === g[4] && 111 === g[5] && 114 === g[6] && 116 === g[7] ? ((g = (g[8] << 8) | g[9]), R.qf.Hh(a, b), (b.port = g), R.qf.jh(a, b)) : (a.ag.push({ hf: b.hf, port: b.port, data: g }), f.websocket.emit("message", a.stream.fd));
          }
          var e = !0;
          h
            ? (b.socket.on("open", c),
        ...
        bind: function (a, b, c) {
          if ("undefined" !== typeof a.Bg || "undefined" !== typeof a.Qf) throw new O.af(28);
          a.Bg = b;
          a.Qf = c;
          if (2 === a.type) {
    ...
    function vd(a, b, c, d) {
      if (c)
        if (((a = V.getUniform(S[a], T[b])), "number" == typeof a || "boolean" == typeof a))
          switch (d) {
            case 0:
              E[c >> 2] = a;
              break;
    ...
    function Kd() {
      if (!Ld) {
        var a = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (("object" === typeof navigator && navigator.languages && navigator.languages[0]) || "C").replace("-", "_") + ".UTF-8", _: ha || "./this.program" },
          b;
    ...
    function Bb(a) {
      ...
      var e = a.Rf + a.cg;
      d = M.Ef[a.$f] = { worker: b, Rf: a.Rf, cg: a.cg, Kg: a.Kg, Lh: a.$f, threadInfoStruct: a.$f };
      ...
      b.yf = d;
      var k = { cmd: "run", start_routine: a.Mi, arg: a.Tf, threadInfoStruct: a.$f, selfThreadId: a.$f, parentThreadId: a.Fi, stackBase: a.Rf, stackSize: a.cg };
      b.og = function () {
    ...
    var Fe = {
          ...
          if (a >= Zc) U(1281);
            ...
            if (d)
              if (35716 == b) ((a = V.getProgramInfoLog(S[a])), null === a && (a = "(unknown error)"), (E[c >> 2] = a.length + 1));
                ...
                if (-1 == d.kg) for (a = S[a], e = V.getProgramParameter(a, 35382), b = d.kg = 0; b < e; ++b) d.kg = Math.max(d.kg, V.getActiveUniformBlockName(a, b).length + 1);
                E[c >> 2] = d.kg;
      ...
      Ab: function (a, b, c) {
        if (288 >= b) for (var d = yd[b - 1], e = 0; e < b; ++e) d[e] = G[(c + 4 * e) >> 2];
      ...
      yb: function (a, b, c) {
        if (288 >= b) for (var d = zd[b - 1], e = 0; e < b; ++e) d[e] = E[(c + 4 * e) >> 2];
      ...
      n: function (a, b, c, d) {
        ...
        if (b) {
          ...
          if (0 === E[(b + 16) >> 2]) {
            ...
            if (m || r)
              if (B)
                if (E[(B + 12) >> 2] !== B) u("pthread_getschedparam attempted on thread " + B + ", which does not point to a valid thread, or does not exist anymore!");
                else {
        ...
        a = t + 156;
        E[a >> 2] = a;
        c = { Rf: g, cg: q, Kg: b, Ih: m, Jh: r, detached: k, Mi: c, $f: t, Fi: pb | 0, Tf: d, Vi: e };
      ...
      m: function (a, b, c, d) {
        ...
        var q = E[(d + 40) >> 2];
        d = { Ti: E[d >> 2], Si: E[(d + 4) >> 2], Eg: E[(d + 8) >> 2], pg: E[(d + 12) >> 2], dg: E[(d + 16) >> 2], rf: E[(d + 20) >> 2], Fg: E[(d + 24) >> 2], Gg: E[(d + 28) >> 2], yj: E[(d + 32) >> 2], Ri: E[(d + 36) >> 2], Ui: q ? C(q) : "" };
        c = C(c);
    ...
    function Le(a) {
      ...
      if (!(0 < ab)) {
        if (!l) {
          if (f.preRun) for ("function" == typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length; ) $a();
          nb(Va);
        }
        0 < ab ||
          (f.setStatus
